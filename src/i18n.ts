...
const locales: Record<string, LocaleMap> = {
	...
	fr: {
		...
		"button.forget_password": "🗑️ Réinitialiser le cryptage",
		"button.show": "Afficher",
		"button.hide": "Masquer",

		"msg.export_warning": "⚠️ Attention : le fichier exporté contient des données sensibles telles que votre mot de passe, votre jeton d'accès personnel (PAT) et votre clé API groq. Ne partagez pas ce fichier.",
	...
	en: {
		...
		"button.forget_password": "🗑️ Reset Cryptation",
		"button.show": "Show",
		"button.hide": "Hide",

		"msg.export_warning": "⚠️ Warning: exported file will contain sensitive data such as your password, PAT and groq API key. Do not share this file.",
	...
	zh: {
		...
		"button.refresh": "🔄 刷新",
		"button.restore": "恢复",
		"button.forget_password": "🗑️ 重置加密",
		"button.show": "显示",
		"button.hide": "隐藏",

		"msg.export_warning": "⚠️警告：导出的文件将包含敏感数据，例如您的密码、PAT 和 groq API 密钥。请勿共享此文件。",
